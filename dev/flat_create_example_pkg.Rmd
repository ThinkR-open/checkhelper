...
create_example_pkg <- function(path = tempfile(pattern = "pkg-"), 
  ...
  if (!requireNamespace("usethis", quietly = TRUE) |
      !requireNamespace("attachment", quietly = TRUE)) {return(NULL)} 
  ...
  if (isTRUE(with_extra_notes)) {
    extra_dir_path <- file.path(path, "checkpackage", "inst", "I build", "a very", "long_name",
                                "that should be",
                                "not_ok", "for_checks",
  ...
  if (isTRUE(with_functions)) {
    ...
    # And return empty
    file.copy(system.file("bad-function-examples.R", package = "checkhelper"), 
...
fusen::inflate(flat_file = "dev/flat_create_example_pkg.Rmd", vignette_name = NA,
