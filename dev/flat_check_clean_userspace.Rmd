...
what_changed <- function(local_shot, scratch_shot, source, all_files, check_dir) {
  ...
  file.no.problem <- paste0(check_dir,
                            "|[.]Rcheck/|", 
                            file.path(tempdir(), "callr-"),
                            "|",
                            file.path(tempdir(), "test.*[.](o|c|so)$"),
                            "|",
                            file.path(tempdir(), "foo[.]o$"))
...
fusen::inflate(flat_file = "dev/flat_check_clean_userspace.Rmd", vignette_name = "No files left after check")
```
