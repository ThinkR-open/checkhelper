...
Here we use the CRAN settings and way of managing incoming packages used for Linux in this function `audit_check()`.
...
Although `audit_check()` should run on any OS, it will run CRAN parameters originally set up for Linux machines.
